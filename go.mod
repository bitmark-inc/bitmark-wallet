...
require (
	...
	github.com/bitgoin/address v0.0.2-0.20170617033826-ace0060e54fd
	github.com/bitgoin/packer v0.0.2-0.20161212102034-f44a7cc6790a
	github.com/bitmark-inc/bitmarkd v0.9.1
